...
architecture behavior of PPS_tb2 is
  ...
  constant INST : std_logic_vector(DATA_WIDTH - 1 downto 0) :=
  "01" & -- Opcode
...
begin
  ...
  begin
    ...
    for i in 0 to 255 loop
      s_addr_w <= std_logic_vector(to_unsigned(i, ADDR_WIDTH));
      s_data_w <= INST;
      wait for CLK_PERIOD;
    end loop;
