...
entity PPS is
    ...
    port (
        ...
        error           : out std_logic;
        fsm_read_addr_out : out std_logic_vector(ADDR_WIDTH - 1 downto 0)
    );
end entity PPS;
...
architecture structural of PPS is
    ...
    signal addr_r_internal: std_logic_vector(ADDR_WIDTH - 1 downto 0);
    signal timer_end      : std_logic;
    signal timer_value    : std_logic_vector(PULSE_DURATION_WIDTH - 1 downto 0);
    signal timer_start    : std_logic;
    signal pulse_waveform : std_logic_vector(PULSE_WAVEFORM_WIDTH - 1 downto 0);
...
begin
    ...
    fsm_read_addr_out <= addr_r_internal;
